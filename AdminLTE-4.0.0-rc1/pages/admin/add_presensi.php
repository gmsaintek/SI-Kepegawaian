...
<html>
  <head>
    ...
    <title>Tambah Presensi | Sisforpeg</title>
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="Tambah Presensi | Sisforpeg" />
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
  <div class="app-wrapper">
    ...
    <?php include '../includes/sidebar_admin.php';?> <!--in this case i'd be using sidebar_admin first. mungkin kalau perlu versi yang pake sidebar_user i'll be on it-->
    <main class="app-main">
