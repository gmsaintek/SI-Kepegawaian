        ...
        <div class="container-fluid">
          <div class="row">
            <div class="d-flex mb-2">
              <a href="edit_pegawai.php" class="btn btn-primary">
              ...
              <div class="card card-success card-outline mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="card card-success collapsed-card mb-2">
                    ...
                    <div class="card-body">
                      <div class="d-flex mb-2">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit_family">
                          <i class="bi bi-pencil-square"></i>
                          Edit
                        </button>
                      </div>
                      <div class="modal-container">
                        <?php include "modals/edit_db/family.php";?>
                      </div>
                      <table class="table table-striped">
                        <tbody>
                          <tr>
                  ...
                  <div class="card card-success collapsed-card mb-2">
                    ...
                    <div class="card-body">
                      <div class="d-flex mb-2">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit_pendidikan">
                          <i class="bi bi-pencil-square"></i>
                          Edit
                        </button>
                      </div>
                      <div class="modal-container">
                        <?php include "modals/edit_db/pendidikan.php";?>
                      </div>
                      <table class="table table-striped">
                        <tbody>
                          <th>TK</th>
